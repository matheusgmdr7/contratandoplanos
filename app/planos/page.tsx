        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div className="container relative z-10 px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center text-white">
              ...
              <div className="mt-8">
                <Button asChild size="lg" className="bg-white text-[#168979] hover:bg-white/90 rounded-full">
                  <Link href="/cotacao">
                    Fazer cotação agora
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div className="bg-[#168979]/10 p-3 rounded-full inline-flex mb-6">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border-0">
                <CardHeader className="bg-[#168979] text-white pb-4">
                ...
                <CardContent className="pt-6">
                  ...
                  <Button asChild className="w-full bg-[#168979] hover:bg-[#13786a] rounded-full">
                    <Link href="/cotacao">
                      Fazer cotação
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  <h3 className="text-xl font-semibold mb-6 text-[#168979]">Coberturas Básicas</h3>
                ...
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  <h3 className="text-xl font-semibold mb-6 text-[#168979]">Coberturas Adicionais</h3>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
